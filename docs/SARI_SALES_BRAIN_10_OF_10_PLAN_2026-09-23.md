...
آخر استكمال، 24 سبتمبر 2026: [مراجعة الموظف لموافقة العميل قبل تأكيد الحجز](./SARI_SALES_BRAIN_BOOKING_CONSENT_REVIEW_2026-09-24.md). أضيف عرض اتفاق العميل ورسائله داخل إدارة الحجز وتصديق موظف مرتبط بدليل حديث قبل التأكيد المحلي. تغير الدليل أو الرفض اللاحق يحجب التأكيد، وتعديل الموعد الموافق عليه عبر المسار العام ممنوع. التصديق والتأكيد والتدقيق في معاملة واحدة مع استرداد الطلب المتكرر. ترحيل 0090 يحتفظ بمرجع الموافقة بعد حذف المحادثة؛ backfill موثق على قاعدتي اختبار فقط. التأكيد الخارجي واتفاق تعديل الحجز وبقية سياسات الجدولة باقية. الحالة **4 بنود مكتملة، 55 جزئية، و12 غير مغلقة**؛ الأدلة تحدد النسخة والاختبارات. لا اعتماد 10/10 بالاختبارات المحلية وحدها.
