...
آخر استكمال، 24 سبتمبر 2026: [توحيد حجز السعة ومنع التداخل](./SARI_SALES_BRAIN_BOOKING_CAPACITY_2026-09-24.md). أصبح إنشاء سجل الحجوزات وتعديله وحذفه يمر بقفل مشترك لكل تاجر ومعاملة واحدة، مع منع تداخل الموظف عبر الخدمات والسماح بموظفين مستقلين. اقتراح المواعيد يستخدم الفترات المسجلة والتوافر الحالي، وطلب المحادثة لا يوصف بأنه مؤكد وهو معلق. جدول التقويم القديم منفصل؛ دمجه واتفاق العميل وهوية إنشاء دائمة وسياسات الدوام والتكاملات والتحقق الحي ما زالت مفتوحة. الحالة **4 بنود مكتملة، 55 جزئية، و12 غير مغلقة**؛ ملف الأدلة يحدد الاختبارات وبصمات النسخة. لا اعتماد 10/10 بالاختبارات المحلية وحدها.
