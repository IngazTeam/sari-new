...
آخر استكمال، 24 سبتمبر 2026: [تعديل الموعد بموافقة العميل مع حفظ سجل الاتفاقات](./SARI_SALES_BRAIN_BOOKING_AMENDMENTS_2026-09-24.md). أضيف مسار تعديل الحجز نفسه بموافقة جديدة بعد عرض التفاصيل والسعر، دون تحرير الموعد الأصلي قبل الموافقة. التعديل يعيد مراجعة الموظف ويحفظ الاتفاق السابق؛ التزامن وفقد تأكيد الحفظ لا يكرران الأثر. الحجوزات ذات التاريخ المالي أو الأثر الخارجي تحتاج مراجعة النشاط. ترحيل 0091 واختباراته محلية؛ التأكيد الخارجي وبقية سياسات الجدولة باقية. الحالة **4 بنود مكتملة، 55 جزئية، و12 غير مغلقة**؛ الأدلة تحدد النسخة والاختبارات. لا اعتماد 10/10 بالاختبارات المحلية وحدها.
