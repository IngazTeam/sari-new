...
آخر استكمال، 24 سبتمبر 2026: [حفظ محاولة الدفع المحلية قبل اتصال Tap](./SARI_SALES_BRAIN_DURABLE_CHECKOUT_2026-09-24.md)، بعد [تطبيق الخصم المتفق عليه](./SARI_SALES_BRAIN_CHECKOUT_DISCOUNT_2026-09-24.md). اكتشفت مراجعة تحرير الكوبون فجوة إنشاء جلسة دفع قبل حفظ محاولتها؛ أضيف سجل مسبق وقيد لمحاولة نشطة واحدة لكل طلب، مع حفظ الدفع والنتيجة ذريًا، ومنع إعادة POST للمجهول حتى مع UUID جديد أو مرور الوقت. يظهر للتاجر سجل الحالات والمراجع بصلاحية، دون بيانات الدافع أو إجراء إعادة إرسال. تسوية نتيجة Tap الغامضة وتحرير استخدام الكوبون والروابط العامة والحجوزات والتنفيذ الخارجي والرسوم الآلية ما زالت مفتوحة. الحالة **4 بنود مكتملة، 55 جزئية، و12 غير مغلقة**؛ النتائج وبصمات النسخة في ملف الأدلة. لا اعتماد تلقائي للبوابات بناءً على نجاح الاختبارات المحلية.
