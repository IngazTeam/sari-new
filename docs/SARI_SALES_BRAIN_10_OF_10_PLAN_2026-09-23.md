...
آخر استكمال: [مراجعة إرسال الخصومات داخل المحادثات](./SARI_SALES_BRAIN_OFFER_REVIEW_2026-09-23.md)، بعد [إيصالات مشاركة الخصم واستعادة السجل](./SARI_SALES_BRAIN_OFFER_RECEIPTS_2026-09-23.md). الواجهة تعرض الدليل ونتيجة الإرسال وآخر مراجعة، وتحفظ هوية المراجع وملاحظته مع فحص الإصدار وبصمة الدليل واستعادة ذرية دون إعادة إرسال. الحالة 4 بنود مكتملة، 55 جزئية، و12 غير مغلقة؛ الأعداد النهائية وبصمات النسخة في ملف الأدلة. لا اعتماد تلقائي للبوابات بناءً على نجاح الاختبارات المحلية.
