...
آخر استكمال: [سجل دائم لإصدار الخصومات ومشاركتها](./SARI_SALES_BRAIN_DURABLE_OFFERS_2026-09-23.md)، بعد [صحة العروض واتساق قرار مخ المبيعات](./SARI_SALES_BRAIN_OFFER_TRUTH_2026-09-23.md). الحالة 4 بنود مكتملة، 55 جزئية، و12 غير مغلقة؛ الأعداد النهائية وبصمات النسخة في ملف الأدلة. لا اعتماد تلقائي للبوابات بناءً على نجاح الاختبارات المحلية.
