...
آخر مراجعة: [فحص التنفيذ والمنطق والترجمة والأمان قبل الكوميت](./SARI_SALES_BRAIN_VERIFICATION_2026-09-23.md). النتيجة 3 بنود مكتملة، 53 جزئية، و15 غير مغلقة؛ لا اعتماد تلقائي للبوابات بناءً على نجاح الاختبارات المحلية.
...
- [ ] **B030 — دليل قطاعات قابل للامتداد:** schema لخصائص الاحتياج والأسئلة والعروض والاعتراضات والأفعال المسموحة. تطبيق أولي على التدريب والاستقدام والمتاجر، وقالب عام بقية القطاعات؛ إضافة قطاع لا تتطلب تعديل orchestrator.
