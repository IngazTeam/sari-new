...
آخر استكمال، 24 سبتمبر 2026: [تحرير استخدام الكوبون للطلب الملغى قبل التحصيل](./SARI_SALES_BRAIN_COUPON_RELEASE_2026-09-24.md)، بعد تسوية Tap. مراجعة صريحة تعيد استخداماً واحداً، وتحفظ السبب والعداد قبل وبعد وتغلق الدفع للطلب ذرياً. حالات الغموض والتحصيل والاسترداد والتاريخ القديم محجوبة؛ لا تغيّر الفاتورة أو تكرر التخفيض مع التزامن. التعميم على الموصلات الخارجية والحجوزات والروابط العامة والسياسات المالية الأخرى والتحقق الحي ما زال مفتوحاً. الحالة **4 بنود مكتملة، 55 جزئية، و12 غير مغلقة**؛ ملف الأدلة يحدد الاختبارات وبصمات النسخة. لا اعتماد 10/10 بالاختبارات المحلية وحدها.
