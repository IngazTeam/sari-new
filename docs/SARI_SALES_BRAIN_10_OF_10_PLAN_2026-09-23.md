...
آخر استكمال، 24 سبتمبر 2026: [هوية طلب إنشاء الموعد واسترداد نتيجته](./SARI_SALES_BRAIN_APPOINTMENT_IDENTITY_2026-09-24.md). إنشاء التقويم يحتاج UUID ثابتاً ويحفظ هوية الطلب والفاعل وبصمة المحتوى مع الموعد في المعاملة نفسها. إعادة الطلب تسترد الحالة الحالية دون POST جديد؛ الهوية تبقى بعد حذف الموعد. أضيفت قراءة للنتيجة وصلاحيات صارمة، واختُبرت عمال مستقلة وفقد تأكيد الحفظ. ترحيل 0088 على قاعدتي اختبار فقط. يتطلب العقد تحديث المستدعين؛ موافقة العميل داخل المحادثة وهوية رسالة واتساب وسياسات الدوام وCalendly والتحقق الحي باقية. الحالة **4 بنود مكتملة، 55 جزئية، و12 غير مغلقة**؛ الأدلة تحدد النسخة والاختبارات. لا اعتماد 10/10 بالاختبارات المحلية وحدها.
