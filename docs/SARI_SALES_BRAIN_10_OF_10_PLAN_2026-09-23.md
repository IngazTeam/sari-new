...
آخر استكمال، 24 سبتمبر 2026: [تطبيق الخصم المتفق عليه في الطلب المحلي](./SARI_SALES_BRAIN_CHECKOUT_DISCOUNT_2026-09-24.md)، بعد [استثناء الهامش لفاتورة محددة](./SARI_SALES_BRAIN_MARGIN_EXCEPTION_2026-09-23.md). أمر تطبيق الكود ينشئ ملخصًا جديدًا يحتاج موافقة العميل، واعتماد الفاتورة يعيد فحص الكود والهامش ويستهلك استخدامه مع حفظ السجل ذريًا؛ رابط الدفع يستخدم المبلغ المخفّض نفسه. الإزالة وتعديل الكمية يحتاجان عرضًا جديدًا، ولا يُرفع السعر بصمت عند فقد أهلية الكود. التنفيذ الخارجي والضرائب والتوصيل الآليان وحجز الاستخدام وتحريره بعد الإلغاء ما زالت مفتوحة. الحالة **4 بنود مكتملة، 55 جزئية، و12 غير مغلقة**؛ النتائج وبصمات النسخة في ملف الأدلة. لا اعتماد تلقائي للبوابات بناءً على نجاح الاختبارات المحلية.
