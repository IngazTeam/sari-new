...
آخر استكمال، 24 سبتمبر 2026: [تسوية محاولات Tap المحلية الغامضة](./SARI_SALES_BRAIN_TAP_RECONCILIATION_2026-09-24.md)، بعد حفظ المحاولة قبل الاتصال. يراجع الموظف معرّف العملية ويسترجعها الخادم عبر GET، ويطابق المرجع والدافع والمبلغ وحساب المزوّد ثم يحفظ الدفع والعدادات وذاكرة الشراء وسجل المراجعة ذرياً. 404 أو الغموض لا يسمحان بدفعة جديدة، وسباق webhook أو تغير الدليل يمنع التسوية القديمة. تحرير استخدام الكوبون وتعميم الآلية على الحجوزات والروابط العامة وبقية الموصلات والتحقق الحي ما زالت مفتوحة. الحالة **4 بنود مكتملة، 55 جزئية، و12 غير مغلقة**؛ ملف الأدلة يحدد الاختبارات وبصمات النسخة. لا اعتماد 10/10 بالاختبارات المحلية وحدها.
