...
آخر استكمال: [حماية هامش الفاتورة المحلية](./SARI_SALES_BRAIN_CHECKOUT_MARGIN_2026-09-23.md)، بعد [صلاحية إصدار الخصومات ومراجعتها](./SARI_SALES_BRAIN_DISCOUNT_AUTHORITY_2026-09-23.md). أضيف حد قابل للتفعيل بمراجعة وصلاحية وإصدار وتدقيق، مع حساب فعلي للتكاليف والضريبة والتوصيل وإعادة التحقق عند الاعتماد. نقص التكلفة أو تغير الدليل أو هبوط الهامش يمنع اعتماد الفاتورة دون تغيير مبلغ العميل. أُغلق مساعد خصم قديم كان يعلن نجاحًا دون تعديل الطلب. حماية الأكواد العامة والمتاجر الخارجية وتفويض الصفقة لم تكتمل. الحالة 4 بنود مكتملة، 55 جزئية، و12 غير مغلقة؛ الأعداد النهائية وبصمات النسخة في ملف الأدلة. لا اعتماد تلقائي للبوابات بناءً على نجاح الاختبارات المحلية.
