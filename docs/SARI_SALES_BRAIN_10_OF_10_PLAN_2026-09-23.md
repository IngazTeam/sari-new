...
آخر استكمال: [إيصالات مشاركة الخصم واستعادة سجل المحادثة](./SARI_SALES_BRAIN_OFFER_RECEIPTS_2026-09-23.md)، بعد [سجل إصدار الخصومات ومشاركتها](./SARI_SALES_BRAIN_DURABLE_OFFERS_2026-09-23.md). المشاركة تستخدم حساباً ومفتاحاً ثابتين، والتسوية تتحقق من إيصال مطابق وتصلح التاريخ دون إعادة إرسال. الحالة 4 بنود مكتملة، 55 جزئية، و12 غير مغلقة؛ الأعداد النهائية وبصمات النسخة في ملف الأدلة. لا اعتماد تلقائي للبوابات بناءً على نجاح الاختبارات المحلية.
