...
آخر استكمال: [استثناء موثق لهامش فاتورة محددة](./SARI_SALES_BRAIN_MARGIN_EXCEPTION_2026-09-23.md)، بعد [حماية هامش الفاتورة المحلية](./SARI_SALES_BRAIN_CHECKOUT_MARGIN_2026-09-23.md). يستطيع المالك أو المدير اعتماد فاتورة دون الحد بسبب مكتوب ومراجعة للتكاليف وبصمة حديثة، مع حفظ التدقيق والاعتماد ذريًا. لا يتغير حد المتجر أو مبلغ العميل، ولا تُستثنى تكلفة ناقصة. يظهر السجل الأصلي في تفاصيل الطلب بعد الاعتماد والدفع. حماية الأكواد العامة والمتاجر الخارجية والتنفيذ الفعلي لخصم متفق عليه ما زالت مفتوحة. الحالة 4 بنود مكتملة، 55 جزئية، و12 غير مغلقة؛ الأعداد النهائية وبصمات النسخة في ملف الأدلة. لا اعتماد تلقائي للبوابات بناءً على نجاح الاختبارات المحلية.
