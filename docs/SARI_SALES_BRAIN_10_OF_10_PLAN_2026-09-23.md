...
آخر استكمال، 24 سبتمبر 2026: [حماية دفع الحجوزات](./SARI_SALES_BRAIN_BOOKING_CHECKOUT_2026-09-24.md)، بعد تحرير كوبون الطلب المحلي. رابط حجز ثابت يطابق السعر النهائي والملكية والحالة، ومحاولة محفوظة قبل POST بقيد نشط لكل حجز؛ النتيجة الغامضة لا تكرر الخصم، والتحصيل والاسترداد والذاكرة مختبرة محليًا. الروابط القديمة تبقى محجوبة حتى المراجعة؛ تسوية الحجوزات الغامضة والروابط العامة والموصلات الأخرى والتحقق الحي ما زالت مفتوحة. الحالة **4 بنود مكتملة، 55 جزئية، و12 غير مغلقة**؛ ملف الأدلة يحدد الاختبارات وبصمات النسخة. لا اعتماد 10/10 بالاختبارات المحلية وحدها.
