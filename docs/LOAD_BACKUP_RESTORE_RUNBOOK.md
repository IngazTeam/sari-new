...
تحديث 20 سبتمبر 2026: نُفذ [تمرين استعادة محلي موثّق](SARI_PLAN_REVIEW_AND_PENTEST_2026-09-20.md) على بيانات اصطناعية، ولا يغلق هدف RPO/RTO الإنتاجي. تشمل قائمة الجداول الحرجة الآن دفاتر ميزانية AI والتسليم والعضويات والجلسات ومدفوعات الطلبات. أُضيف charset/collation/generated-expression إلى بصمة الأعمدة؛ أعد توليد manifest المصدر بهذه النسخة قبل مقارنة الاستعادة. مقارنة البصمة وعدد الصفوف وحدها لا تثبت سلامة محتوى البيانات أو المرفقات والأسرار.
