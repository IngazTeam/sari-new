...
## Phase 9: إصلاح وتحسين لوحة التحكم SEO
- [x] إصلاح 300 أخطاء TypeScript في seo-functions.ts
- [x] إضافة صفحة Global SEO Settings
- [x] إضافة المسار إلى App.tsx
- [ ] اختبار جميع صفحات SEO
...
## تحسينات صفحة تجربة ساري (Try Sari)

### 1. نظام Analytics
- [x] إنشاء جدول try_sari_analytics في قاعدة البيانات
- [x] تتبع عدد الزوار (sessions)
- [x] تتبع عدد الرسائل المرسلة
- [x] تتبع الأمثلة المستخدمة
- [x] تتبع معدل التحويل للتسجيل
- [x] إنشاء API لحفظ الإحصائيات
- [ ] إنشاء صفحة لوحة تحكم Analytics للأدمن

### 2. نافذة التسجيل الذكية
- [x] إنشاء مكون SignupPromptDialog
- [x] عداد الرسائل في الصفحة
- [x] إظهار النافذة بعد 3-5 رسائل
- [x] نموذج تسجيل سريع (الاسم، البريد، الجوال)
- [x] زر "لاحقاً" مع عدم الإزعاج مرة أخرى
- [x] تتبع معدل التحويل

### 3. أمثلة محادثة متقدمة
- [x] إضافة سيناريو: طلب متعدد المنتجات
- [x] إضافة سيناريو: استفسار عن توفر منتج محدد
...
## Phase 6: تحميل البيانات الحقيقية من Green API
- [x] إنشاء سكريبت لسحب البيانات من Green API
- [x] تحميل المحادثات الحقيقية من الحساب
- [x] تحميل الرسائل والمتفاعلات
- [x] تحميل حالات الاتصال
- [x] تحديث قاعدة البيانات بالبيانات الحقيقية
- [x] التحقق من صحة البيانات المحملة

## Phase 7: رسوم بيانية متقدمة وتقارير تفاعلية
- [x] إضافة رسوم بيانية متقدمة (Composed, Pie, Area, Bar)
- [x] إنشاء تقارير PDF قابلة للتصدير
- [x] إضافة مقارنات زمنية
- [x] إنشاء لوحة تحليلات متقدمة
- [x] إضافة نظام التنبيهات الذكية
- [x] إنشاء تقارير مجدولة

## Phase 8: Sitemap XML و robots.txt
- [x] إنشاء Sitemap XML ديناميكي
- [x] إنشاء robots.txt محسّم
- [x] إضافة Canonical Tags
...
## إصلاح نظام Webhook للرد التلقائي
- [x] تشخيص المشكلة (Webhook URL غير مضاف في Green API)
- [x] إضافة Webhook URL في لوحة تحكم Green API
- [x] إضافة Instance 7105411382 إلى قاعدة البيانات
- [x] إصلاح خطأ قاعدة البيانات (mediaUrl column)
- [x] إنشاء checkpoint للنشر
- [ ] نشر الموقع على عنوان دائم
- [ ] تحديث Webhook URL في Green API ليشير إلى العنوان المنشور
- [ ] اختبار استقبال الرسائل والرد التلقائي

## تشخيص مشكلة عدم الرد التلقائي (Webhook Not Working)
- [ ] فحص استقبال Webhook من Green API
- [ ] التحقق من سجل الرسائل في قاعدة البيانات
- [ ] فحص إعدادات الرد التلقائي (bot_settings)
