...
ALTER TABLE `payment_transactions` ADD CONSTRAINT `pt_sub_id_fk` FOREIGN KEY (`subscription_id`) REFERENCES `merchant_subscriptions`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
