...
const getAdminMenuItems = (t: any): MenuItem[] => [
  ...
  { icon: FileText, label: t('sidebar.admin.invoices', 'الفواتير'), path: "/admin/invoices" },
  { icon: TrendingUp, label: t('sidebar.admin.subscriptionReports', 'تقارير الاشتراكات'), path: "/admin/subscription-reports" },
  { icon: Bell, label: t('sidebar.admin.notifications', 'الإشعارات'), path: "/admin/notifications" },
  { icon: Zap, label: t('sidebar.admin.abTests', 'اختبارات A/B'), path: "/admin/ab-test-dashboard" },
