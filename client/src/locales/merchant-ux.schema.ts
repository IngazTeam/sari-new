...
import type { SalesReplySendCopy } from './sales-reply-send';
...
export type MerchantUxCopy = {
  ...
  replyReview: SalesReplyReviewCopy;
  replySend: SalesReplySendCopy;
  ...
  bookingCancellation: CopySection<readonly ["noticeTitle","noticeText","title","description","none","cancelling","unknown","cancelled","binding","financial","changed","requestMissing","booking","inFlight","loading","failed","timezone","source","messageId","reason","attest","cancel","verify","history","working","refresh"]>;
  bookingCalendar: CopySection<readonly ["noticeTitle","noticeText","title","description","none","creating","unknown","synced","legacy","account","binding","inFlight","consent","loading","failed","target","event","checked","reason","attest","create","verify","history","working","refresh"]>;
