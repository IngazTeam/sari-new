...
export type MerchantUxCopy = {
  ...
  bookingReschedule: CopySection<readonly ["title","description","pending","moving","unknown","applied","abandoned","binding","changed","financial","booking","consent","availability","inFlight","loading","failed","before","after","timezone","agreement","messageId","reason","attest","move","verify","abandon","history","working","refresh"]>;
