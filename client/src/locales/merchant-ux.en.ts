...
import { salesReplySendEn } from './sales-reply-send';
...
const merchantUxEn: MerchantUxCopy = {
  ...
  experimentLaunch: salesExperimentLaunchEn,
  ...
  "loadFailed": "The current status could not be loaded. Refresh to try again.",
  "updated": "Last updated",
  "nextAttempt": "Next attempt eligible from",
  "proposals": "Proposals in this cycle",
  "scope": "Refreshing only reads status; it never starts analysis or resends a request. Proposals need evaluation and approval before use in sales.",
  "idle": "No saved analysis job",
  "idleHint": "Conversation evidence is being collected. No saved job does not mean learning is complete.",
  "preparing": "Analysis reserved",
  "preparingHint": "Dispatch has not been recorded. A reservation alone does not prove a provider request was sent.",
  "budgetWait": "Analysis deferred by usage limits",
  "budgetWaitHint": "Admission was denied before contacting the model. A later analysis trigger may try again after the delay.",
  "awaitingResult": "Awaiting request outcome",
  "awaitingResultHint": "Dispatch intent was recorded. A delayed result will not cause an automatic replacement request that could repeat the cost.",
  "uncertain": "Request outcome unconfirmed",
  "uncertainHint": "The provider outcome could not be confirmed. Operational review is needed; elapsed time alone is not a reason to resend.",
  "saved": "Result saved, awaiting processing",
  "savedHint": "The system will try to save proposals from the existing result, without another AI request.",
  "recovering": "Completing result storage",
  "recoveringHint": "The recovery worker is processing the saved result. Proposals are not complete until storage succeeds.",
  "retryScheduled": "Storage retry scheduled",
  "retryScheduledHint": "Proposal storage could not finish. The system will retry local storage after a delay without requesting the model again.",
  "applied": "Analysis result saved",
  "appliedHint": "Proposals are ready for review, not approved sales policies. A valid cycle can produce no proposals.",
  "stale": "Analysis sources changed",
  "staleHint": "The result was not used after its sources changed, were removed or had already been processed.",
  "invalid": "Result cannot become a proposal",
  "invalidHint": "The result was rejected or could not be linked to an open proposal. No sales policy was activated."
},
  ...
  bookingNotification: {
    sourceMissing: "The original WhatsApp channel is not verified. A person must confirm the appropriate contact channel.",
    contextChanged: "Sending stopped because the customer or booking context changed. Review the conversation and appointment before any new contact.",
    receiptUnverified: "No matching send evidence can be verified. Do not assume the customer received the message.",
    providerUnconfirmed: "Sending is unconfirmed or the provider reported failure. Check the displayed delivery status.",
    conversationUnavailable: "The original conversation is unavailable or the customer number changed. The message will not be added to another conversation.",
    projectionConflict: "The conversation history conflicts with this message. Existing records will not be overwritten.",
    projectionMissing: "Provider acceptance is verified, but the message needs recovery into conversation history.",
    otherIssue: "This notification requires a person to review the available evidence.",
    attemptAt: "Send attempt time:",
    receipt: "Provider message reference:",
    scope: "This review checks saved send records and restores the message to conversation history when sending is verified. It sends no new message and cannot prove delivery without a provider receipt.",
    reason: "Reason for review and what you checked",
    attest: "I reviewed the notification text and delivery evidence. Recording this review does not confirm the customer received the message.",
    verify: "Check records and record review",
    refresh: "Refresh notification evidence",
    working: "Checking saved records…",
    failed: "The review or its result could not be refreshed. Refresh evidence before another attempt.",
    done: "Review recorded. The displayed delivery status is the available evidence; no new message was sent.",
    history: "Notification review history",
    actor: "Reviewer #{{id}}",
    projected: "The message is verified in conversation history.",
    notProjected: "The message is not verified in conversation history.",
  },
  bookingReschedule: {
    noticeTitle: "Notify customer of the move",
    noticePending: "Notification saved and awaiting dispatch",
    noticeDispatching: "Sending notification",
    noticeAccepted: "WhatsApp provider accepted the message",
    noticeUnknown: "Dispatch outcome is uncertain; no automatic resend",
    noticeFailed: "Dispatch is unverified; review customer communication",
    noticeSuppressed: "Dispatch stopped because booking or conversation context changed",
    noticeManual: "Verify the original WhatsApp account before notifying the customer",
    noticeSent: "Acceptance does not prove delivery or reading.",
    noticeDelivered: "WhatsApp reported delivery",
    noticeRead: "WhatsApp reported the message read",
    noticeDeliveryFailed: "WhatsApp reported delivery failure",
    noticeUnverified: "No verified delivery or read receipt.",
    noticeScope: "Status is updated from WhatsApp receipts. Refreshing this panel does not resend the message.",
    noticeProjection: "Dispatch was accepted; conversation history requires review.",
    noticeText: "Move notification text",
