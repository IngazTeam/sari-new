  ...
  services: [
    {
      ...
      heroDescription: 'حوّل استفسارات المتدربين إلى مسار تسجيل قابل للتتبع. يعرض ساري تفاصيل الدورة والمقاعد من المصدر المربوط، ولا يؤكد التسجيل أو الدفع قبل استلام نتيجة موثقة.',
      ...
      howItWorks: [
        ...
        {
          title: 'الدفع والتسجيل الموثّق',
          description: 'إرسال رابط مزود الدفع أو منصة التدريب المربوطة، ثم تأكيد النتيجة بعد تحقق الخادم منها.',
          icon: CreditCard
        }
      ],
      chatScenarios: [
      ...
      objections: [
        {
          ...
          response: 'يرسل ساري رابطًا صادرًا من بوابة الدفع المتحققة أو منصة التدريب المربوطة، ولا يطلب بيانات البطاقة داخل المحادثة. يظهر التأكيد فقط بعد وصول حالة دفع موثقة؛ الفاتورة ووسائل الدفع تتبعان إعدادات المركز ومزوده.',
          icon: CheckCircle2
        }
      ],
      faqs: [
        {
          ...
          answer: 'يمكن ذلك عندما تدعم منصتكم API التسجيل ويكون الربط موثقًا. لا يعد ساري التسجيل مكتملًا قبل أن تعيد المنصة معرف تسجيل صالحًا، وتأكيد الدفع له تحقق مستقل.'
        }
      ]
    },
    {
      ...
      metaDescription: 'جدولة تذكير المتدربين بحصص Zoom وإرسال رابط الشهادة عند تحقق شروط الاجتياز عبر النظام المربوط.',
      heroTitle: 'تذكيرات الحصص وإرسال الشهادات',
      heroDescription: 'جدول تنبيهات قبل حصص البث المباشر، وأرسل رابط الشهادة بعد أن يعيد النظام المربوط نتيجة الأهلية. يُقاس أثر التذكير على الحضور لكل مركز بدل افتراض نسبة تحسن.',
    ...
    },
    {
      ...
      heroDescription: 'استخدم واتساب لإعلان الدورات للمتدربين الذين وافقوا على الرسائل، ومتابعة قوائم الانتظار بعروض قابلة للقياس دون افتراض زيادة مسبقة في التحويل.',
      ...
      howItWorks: [
        ...
        },
        {
          ...
          description: 'توزيع أكواد التسجيل المبكر (Early Bird) وقياس استخدامها بدل افتراض أثرها على المبيعات.',
          icon: TrendingUp
        }
      ],
      chatScenarios: [
      ...
      objections: [
        {
          ...
          response: 'الإرسال التدريجي لا يضمن تجنب الحظر. يجب مراسلة من لديهم موافقة صالحة، واحترام إلغاء الاشتراك وحدود المزود، واستخدام القوالب المعتمدة عندما تتطلبها قناة WhatsApp الرسمية.',
          icon: CheckCircle2
        }
      ],
      faqs: [
