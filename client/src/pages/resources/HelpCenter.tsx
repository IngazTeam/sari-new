  ...
  const faqs = [
    {
      ...
      questions: [
        {
          q: "كيف أبدأ مع ساري؟",
          a: "أنشئ حسابًا، أكمل بيانات المتجر، ثم اربط قناة واتساب وأضف المنتجات. تعرض لوحة الإعداد حالة كل متطلب؛ يعتمد وقت الجاهزية على تحقق القناة والتكاملات، ويجب إرسال حملة اختبارية إلى مستلمين موافقين قبل أي إطلاق."
        },
        {
          q: "هل أحتاج لخبرة تقنية لاستخدام ساري؟",
          a: "لا تحتاج إلى البرمجة للاستخدام اليومي. بعض القنوات والتكاملات تتطلب بيانات اعتماد ومراجعة إعدادات؛ استخدم مركز المساعدة أو افتح طلب دعم موثق إذا توقفت خطوة."
        },
        {
          q: "ما هي المتطلبات الأساسية؟",
          a: "تحتاج إلى حساب متجر وبيانات منتجات أو خدمات، وقناة WhatsApp مناسبة لمسارك. قد تتطلب Meta موافقة وإعداد WABA، بينما مسار QR القديم للبيتا له قيود تشغيل مختلفة."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          a: "انتقل إلى إعداد واتساب واختر المسار المتاح لحسابك. الربط الرسمي يستخدم Meta Embedded Signup عند اعتماده، ومسار QR القديم مخصص للبيتا ولا يعني أن الرقم معتمد من Meta. لا تعتبر القناة جاهزة حتى تعرض لوحة الإعداد حالتها الفعلية."
        },
        {
        ...
        },
        {
          ...
          a: "تعرض لوحة القناة آخر حالة اتصال معروفة. عند الانقطاع اختبر الاتصال واتبع إجراء إعادة الربط الخاص بالمزود؛ لا تستخدم QR لمسار Meta، ولا تفترض وصول تنبيه ما لم يكن مفعّلًا ومثبتًا في حسابك."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          a: "يستخدم ساري مزود الذكاء المهيأ للحساب مع بيانات متجرك لصياغة الرد. يجب اختبار الإجابات وحدود التصعيد، ولا يؤكد ساري طلبًا أو دفعًا ما لم تُحفظ العملية وتعد نتيجة موثقة."
        },
        {
      ...
      questions: [
        {
          ...
          a: "يدعم المسار الحالي Tap Payments عند إدخال مفاتيح التاجر والتحقق منها. وسائل الدفع والرسوم والتسوية يحددها حسابك لدى Tap، وتأكيد النجاح يعتمد على callback موثّق لا على فتح الرابط."
        },
        {
