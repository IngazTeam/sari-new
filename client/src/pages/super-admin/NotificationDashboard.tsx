...
export default function NotificationDashboard() {
  ...
  const getTypeLabel = (type: string) => {
    const labels: Record<string, string> = {
      ...
      order_status: "Õ«·… «·ÿ·»",
      missed_message: "—”«·… ›«∆ …",
      whatsapp_disconnect: "«‰ﬁÿ«⁄ Ê« ”«»",
      weekly_report: " ﬁ—Ì— √”»Ê⁄Ì",
      custom: "„Œ’’",
    };
              ...
              {statsByType.map((stat) => (
                <div key={stat.type} className="border rounded-lg p-4">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <div className="text-green-600">‰ÃÕ: {stat.sent}</div>
                    <div className="text-red-600">›‘·: {stat.failed}</div>
                  </div>
                </div>
              ))}
            </div>
