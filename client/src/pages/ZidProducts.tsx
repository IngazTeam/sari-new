...
export default function ZidProducts() {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div>
        <h1 className="text-3xl font-bold">مزامنة المنتجات من Zid</h1>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="pt-4 border-t">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
              <li>سيتم جلب جميع المنتجات النشطة من متجرك</li>
              <li>قد تستغرق العملية بضع دقائق حسب عدد المنتجات</li>
              <li>يمكنك تفعيل المزامنة التلقائية من الإعدادات</li>
            </ul>
          </div>
        </CardContent>
      </Card>
