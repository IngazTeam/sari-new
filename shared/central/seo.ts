...
export function renderCentralDocument(
  ...
  return template
    ...
    .replace(
      "</head>",
      `${renderCentralHead(url.pathname, lang)}<link rel="stylesheet" href="/central/central.css?v=20260923-2"><link rel="stylesheet" href="/central/refinements.css?v=20260923-2"></head>`
    )
    .replace(
      '<div id="root"></div>',
