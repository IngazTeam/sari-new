...
export function buildPackDocumentation({ catalog, sourceSha, testEvidence }) {
  const runtime = JSON.parse(readFileSync(resolve(repositoryRoot, 'package.json'), 'utf8'));
