...
const onlyReplyReview = process.argv.includes('--only-reply-review');
...
async function main() {
  ...
  try {
    ...
    if (!onlyPlanningReview && !onlyInspection && !onlyCohort && !onlyPolicyReview && !onlyEvaluation && !onlyProtocol) {
