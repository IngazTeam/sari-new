...
async function render() {
  ...
  if(mode.startsWith('protocol-') || mode.startsWith('cohort-')){createRoot(document.getElementById('root')!).render(<main className="mx-auto max-w-6xl p-3">{(mode==='protocol-standalone'||mode.startsWith('cohort-'))?<SalesExperimentProtocol/>:<LearningPolicyEvaluationPanel proposalId={16}/>}</main>);return;}
