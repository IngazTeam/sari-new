...
const mode = (rawMode.startsWith('cohort-') || rawMode.startsWith('inspection-') || rawMode.startsWith('plan-review-') || rawMode.startsWith('launch-')) ? 'cohort' : rawMode.replace('protocol-', '') || 'ready';
...
if (rawMode.startsWith('plan-review-') || rawMode.startsWith('launch-')) records.set(45, planningReviewFixtureRecord());
