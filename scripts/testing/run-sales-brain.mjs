...
const units = [
  ...
  'server/sales-order-settlement-access-pentest.test.ts',
  'server/ai/sales-order-fact-pentest.test.ts',
  'server/ai/sales-order-worker-pentest.test.ts',
  'server/sales-order-attribution-access-pentest.test.ts',
  'server/ai/sales-payment-timeline-pentest.test.ts',
  'server/sales-payment-timeline-access-pentest.test.ts',
  'server/ai/sales-payment-fact-pentest.test.ts',
  'server/ai/sales-payment-worker-pentest.test.ts',
  'server/sales-payment-attribution-access-pentest.test.ts',
  'server/ai/sales-experiment-exposure-pentest.test.ts',
  'server/ai/ordinary-reply-usage-pentest.test.ts',
  'server/ai/sales-reply-recovery-pentest.test.ts',
  ...
  'server/ai/sales-experiment-generation-pentest.test.ts',
  'server/ai/sales-experiment-turn-pentest.test.ts',
  'server/ai/sales-experiment-assignment-pentest.test.ts',
  'server/sales-launch-ui-pentest.test.ts',
  'server/ai/sales-experiment-launch-pentest.test.ts',
  'server/sales-experiment-launch-access-pentest.test.ts',
...
const database = [
  ...
  'server/ai/sales-payment-attribution.mysql.test.ts',
  'server/ai/ordinary-reply-usage.mysql.test.ts',
  'server/ai/reply-reservation.mysql.test.ts',
  'server/ai/sales-experiment-generation.mysql.test.ts',
  'server/ai/sales-experiment-turn.mysql.test.ts',
  'server/ai/sales-experiment-assignment.mysql.test.ts',
  'server/ai/sales-experiment-launch.mysql.test.ts',
