...
export const CRITICAL_SCHEMA_REQUIREMENTS: readonly SchemaRequirement[] = [
  ...
  { table: 'ai_sales_playbooks' }, { table: 'knowledge_changelog' }, { table: 'sari_response_cache' },
  { table: 'sales_quotations', columns: ['checkout_snapshot', 'external_provider', 'external_snapshot', 'execution_state', 'external_result'] }, { table: 'sales_targets' }, { table: 'quotation_templates' },
