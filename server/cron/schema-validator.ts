...
export const CRITICAL_SCHEMA_REQUIREMENTS: readonly SchemaRequirement[] = [
  ...
  { table: 'ai_learning_analysis_jobs', columns: ['source_digest','claim_token','response_hash','recovery_token','recovery_lease_until','recovery_next_at','recovery_attempts','recovery_last_error','recovered_at','ai_reservation_key'] },
