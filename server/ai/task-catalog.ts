...
function operationalTask(definition: {
  ...
  owner: string;
  sourceFiles: readonly string[];
  inputKind: TaskDefinition["inputKind"];
  outputKind: TaskDefinition["outputKind"];
  fallback: string;
  priority?: TaskDefinition["priority"];
  execution?: TaskDefinition["execution"];
  humanReviewRequired?: boolean;
  timeoutMs?: number;
}): TaskDefinition {
  return {
    ...
    humanReviewRequired: definition.humanReviewRequired ?? false,
    timeoutMs: definition.timeoutMs ?? 25_000,
    ...definition,
  };
}
...
const TASK_DEFINITIONS: readonly TaskDefinition[] = [
  ...
  operationalTask({
    ...
    businessNameAr: "تحليل ملف التاجر المعرفي",
    owner: "sari-knowledge-team",
    sourceFiles: ["server/_core/index.ts"],
    inputKind: "analysis",
    outputKind: "analysis",
    fallback: "retain_extracted_profile_text",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.knowledge.content-analysis",
    businessNameAr: "تحليل محتوى قاعدة المعرفة",
    owner: "sari-knowledge-team",
    sourceFiles: ["server/routers-sari-brain.ts"],
    inputKind: "analysis",
    outputKind: "analysis",
    fallback: "require_manual_content_review",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.website.catalog-extraction",
    businessNameAr: "استخراج كتالوج الموقع",
    owner: "sari-onboarding-team",
    sourceFiles: ["server/_core/websiteAnalyzer.ts"],
    inputKind: "catalog",
    outputKind: "analysis",
    fallback: "retain_html_extracted_catalog",
  }),
  operationalTask({
    taskType: "sari.website.insights",
    businessNameAr: "توليد رؤى الموقع",
    owner: "sari-onboarding-team",
    sourceFiles: ["server/_core/websiteAnalyzer.ts"],
    inputKind: "analysis",
    outputKind: "analysis",
    fallback: "show_deterministic_site_metrics",
  }),
  operationalTask({
    taskType: "sari.website.industry",
    businessNameAr: "تصنيف مجال الموقع",
    owner: "sari-onboarding-team",
    sourceFiles: ["server/_core/websiteAnalyzer.ts"],
    inputKind: "analysis",
    outputKind: "classification",
    fallback: "mark_industry_unknown",
  }),
  operationalTask({
    taskType: "sari.website.competitor-analysis",
    businessNameAr: "تحليل منافسي الموقع",
    owner: "sari-onboarding-team",
    sourceFiles: ["server/_core/websiteAnalyzer.ts"],
    inputKind: "analysis",
    outputKind: "analysis",
    fallback: "continue_without_competitor_summary",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.website.full-extraction",
    businessNameAr: "الاستخراج الكامل لمحتوى الموقع",
    owner: "sari-onboarding-team",
    sourceFiles: ["server/_core/websiteAnalyzer.ts"],
    inputKind: "analysis",
    outputKind: "analysis",
    fallback: "retain_deterministic_site_extraction",
  }),
  operationalTask({
    taskType: "sari.website.content-classification",
    businessNameAr: "تصنيف محتوى صفحة الموقع",
    owner: "sari-onboarding-team",
    sourceFiles: ["server/routers-sari-brain.ts"],
    inputKind: "analysis",
    outputKind: "classification",
    fallback: "require_manual_page_classification",
  }),
  operationalTask({
    taskType: "sari.booking.extract",
    businessNameAr: "استخراج بيانات الحجز",
    owner: "sari-booking-team",
    sourceFiles: ["server/ai.ts"],
    inputKind: "conversation",
    outputKind: "analysis",
    fallback: "request_missing_booking_fields",
  }),
  operationalTask({
    taskType: "sari.booking.service-match",
    businessNameAr: "مطابقة طلب الحجز بالخدمة",
    owner: "sari-booking-team",
    sourceFiles: ["server/ai.ts"],
    inputKind: "catalog",
    outputKind: "recommendation",
    fallback: "require_manual_service_selection",
  }),
  operationalTask({
  ...
  operationalTask({
    ...
    businessNameAr: "استخراج الطلب من المحادثة",
    owner: "sari-commerce-team",
    sourceFiles: ["server/automation/order-from-chat.ts"],
    inputKind: "conversation",
    outputKind: "analysis",
    fallback: "require_manual_order_confirmation",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.order.zid-extract",
    businessNameAr: "استخراج طلب زد من المحادثة",
    owner: "sari-commerce-team",
    sourceFiles: ["server/automation/zid-order-from-chat.ts"],
    inputKind: "conversation",
    outputKind: "analysis",
    fallback: "require_manual_zid_order_confirmation",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.catalog.file-sales-analysis",
    businessNameAr: "تحليل ملف الكتالوج للمبيعات",
    owner: "sari-commerce-team",
    sourceFiles: ["server/routers-products.ts"],
    inputKind: "catalog",
    outputKind: "analysis",
    fallback: "retain_imported_catalog_rows",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.catalog.file-extraction",
    businessNameAr: "استخراج عناصر ملف الكتالوج",
    owner: "sari-commerce-team",
    sourceFiles: ["server/routers-products.ts"],
    inputKind: "catalog",
    outputKind: "analysis",
    fallback: "require_manual_catalog_mapping",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.product.selection",
    businessNameAr: "تحديد المنتج المختار",
    owner: "sari-commerce-team",
    sourceFiles: ["server/ai/product-intelligence.ts"],
    inputKind: "catalog",
    outputKind: "recommendation",
    fallback: "request_product_clarification",
  }),
  operationalTask({
    taskType: "sari.keyword.frequent-questions",
    businessNameAr: "تحليل الأسئلة المتكررة",
    owner: "sari-insights-team",
    sourceFiles: ["server/ai/keyword-analysis.ts"],
    inputKind: "conversation",
    outputKind: "analysis",
  ...
  operationalTask({
    ...
    inputKind: "conversation",
    outputKind: "classification",
    fallback: "treat_as_same_topic",
  }),
  operationalTask({
    taskType: "sari.response.critique",
    businessNameAr: "تقييم جودة الرد",
    owner: "sari-quality-team",
    sourceFiles: ["server/ai/response-critic.ts"],
    inputKind: "conversation",
    outputKind: "analysis",
    fallback: "pass_through_original_response",
  }),
  operationalTask({
    taskType: "sari.response.rewrite",
    businessNameAr: "إعادة صياغة الرد",
    owner: "sari-quality-team",
    sourceFiles: ["server/ai/response-critic.ts"],
    inputKind: "conversation",
    outputKind: "text",
    fallback: "use_original_response",
  }),
  operationalTask({
    taskType: "sari.response.validate",
    businessNameAr: "التحقق الدلالي من الرد",
    owner: "sari-quality-team",
    sourceFiles: ["server/ai/response-validator.ts"],
    inputKind: "conversation",
    outputKind: "analysis",
    fallback: "apply_deterministic_validation_only",
  }),
  operationalTask({
    taskType: "sari.response.correct",
    businessNameAr: "تصحيح الرد غير المطابق",
    owner: "sari-quality-team",
    sourceFiles: ["server/ai/response-validator.ts"],
    inputKind: "conversation",
    outputKind: "text",
    fallback: "use_sanitized_original_response",
  }),
  operationalTask({
    taskType: "sari.reply.suggestions",
    businessNameAr: "اقتراح ردود للمحادثة",
    owner: "sari-conversation-team",
    sourceFiles: ["server/routers-ai-suggestions.ts"],
    inputKind: "conversation",
    outputKind: "analysis",
    fallback: "show_no_reply_suggestions",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.reply.custom",
    businessNameAr: "صياغة رد مخصص",
    owner: "sari-conversation-team",
    sourceFiles: ["server/routers-ai-suggestions.ts"],
    inputKind: "conversation",
    outputKind: "text",
    fallback: "require_manual_reply",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.reply.improve",
    businessNameAr: "تحسين رد مكتوب",
    owner: "sari-conversation-team",
    sourceFiles: ["server/routers-ai-suggestions.ts"],
    inputKind: "message",
    outputKind: "text",
    fallback: "retain_original_reply",
    humanReviewRequired: true,
  }),
  operationalTask({
    taskType: "sari.platform.health",
    businessNameAr: "فحص اتصال منصة ساري",
    owner: "sari-platform-team",
    sourceFiles: ["server/routers-ai-settings.ts"],
    inputKind: "message",
    outputKind: "text",
    fallback: "report_gateway_unavailable",
    timeoutMs: 15_000,
  }),
  {
