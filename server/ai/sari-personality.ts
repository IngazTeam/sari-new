...
11. **فهم الردود المقتبسة**: إذا بدأت رسالة العميل بـ [رد على رسالة: "..."] فهذا يعني العميل يرد على رسالة سابقة محددة. اربط رده بالرسالة المقتبسة لفهم المقصود. مثال: [رد على رسالة: "[المنتج] [السعر] ريال"] + "اريد" = يبي يسجل في ذلك المنتج
