...
export const salesReplyReviewChecks = z.object({ answersQuestion: z.boolean(), groundedInBusiness: z.boolean(),
  appropriateNextStep: z.boolean(), respectsCustomerDecision: z.boolean(), noUnverifiedCommitment: z.boolean(), languageAndClarity: z.boolean() }).strict();
...
export const salesReplyReviewBasis = z.object({ version: z.literal('sales-reply-review-basis.v1'), merchantId: id, generationId: id,
